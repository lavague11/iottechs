...
Still open by design: install photos, install-appointment confirm and completion docs remain advisory (no data source); per-item dual QC signatures are a future build; Sales has no Install branch; Vendor/Readonly have no render branch.
