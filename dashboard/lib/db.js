...
const MOBILE_SETUP_GUIDE = {
  ...
  steps: [
    ...
    { art: "account",  image: "/guides/annke/07.png", title: "Number and password", text: "Type your mobile number, set the password to {PASSWORD}, then tap Get Security Code.", tap: [{ x: 50, y: 28, w: 82, h: 6 }, { x: 50, y: 40, w: 82, h: 6 }, { x: 50, y: 88, w: 88, h: 6 }], why: "Use this exact password. It lets us set up your app for the first week and make any changes for you — and it keeps this a shared account, so we never see your personal login. After the first week, change it to anything you like." },
