      ...
      <div className="cm-box">
        ...
        <form className="cm-form" onSubmit={submit}>
          <div className="cm-row2">
            ...
            <div className="cm-f"><label>Company <span className="opt">(optional)</span></label><input className="apx-input" value={f.company} onChange={(e) => set("company", e.target.value)} placeholder="Used as the customer name" /></div>
          </div>
          <div className="cm-row2">
          ...
          <div className="cm-f"><label>Service Address</label><input className="apx-input" value={f.address} onChange={(e) => set("address", e.target.value)} placeholder="123 Main St, City, NJ" /></div>
