...
function ApplyStep({ prefill = null }) {
  ...
  return (
    <form className="adt-card" onSubmit={submit}>
      ...
      {prefill?.name && <div className="adt-prefill">✓ We pre-filled what's on your account — review it, add your equipment and secure details, then submit.</div>}
...
.adt-prefill{margin:0 0 18px;padding:11px 14px;border-radius:11px;background:#eef7f0;border:1px solid #c9e4d1;color:#1c6b45;font-size:.86rem;font-weight:600}
